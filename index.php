    ...
    <div class="hotel-grid">
      ...
      <div class="swiper-container hotel__slider hotel-slider">
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide hotel-slider__item">
            <img class="hotel-slider__img" src="img/slide2.jpg" alt="slide" />
          </div>
          <div class="swiper-slide hotel-slider__item">
            <img class="hotel-slider__img" src="img/slide3.jpg" alt="slide" />
          </div>
        </div>
      ...
      <div class="packages-item first">
        ...
        <div class="packages-item__text first__text">
          <div class="info">
            ...
            <h3 class="packages-item__title first__title">Hotel Blue Haven</h3>
          </div>
